<?php
class WheatfieldDemandRedemptionRequest
{
     ...
     public function setInterestamount($interestamount)
     {
         ...
         $this->apiParas["interestamount"] = $interestamount;
     }
     ...
     public function setCapitalamount($capitalamount)
     {
         ...
         $this->apiParas["capitalamount"] = $capitalamount;
     }
     ...
     {
         return "ruixue.wheatfield.demand.redemption";
     }
