<?php
class WheatfieldOrderServiceKzhcollectionRequest
{
     ...
     public function getLoanorderid()
     {
         return $this->$loanorderid;
     }

     public function setLoanorderid($loanorderid)
     {
         $this->loanorderid = $loanorderid;
         $this->apiParas["loanorderid"] = $loanorderid;
     }
     ...
     {
         return "ruixue.wheatfield.order.service.kzhcollection";
     }
