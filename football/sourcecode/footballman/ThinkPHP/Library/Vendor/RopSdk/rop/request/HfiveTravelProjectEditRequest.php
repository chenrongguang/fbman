<?php
class HfiveTravelProjectEditRequest
{
     private $apiParas = array();

     private $bw_dj_yn;

     public function getBwDjYn()
     {
         return $this->$bw_dj_yn;
     }

     public function setBwDjYn($bw_dj_yn)
     {
         $this->bw_dj_yn = $bw_dj_yn;
         $this->apiParas["bw_dj_yn"] = $bw_dj_yn;
     }
     ...
     {
         return "ruixue.hfive.travel.project.edit";
     }
